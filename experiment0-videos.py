...
videoworkflow = 'bonsai/tracking.bonsai'
...
def exportvideo(path, prefix, framerate, start, end):
...
for session in data.itertuples():                                 # for all sessions
    ...
    exportvideo(path, 'FrameTop', 50, start, end)                 # track and export top video
    exportvideo(path, 'FrameSide', 125, start, end)               # track and export side video
